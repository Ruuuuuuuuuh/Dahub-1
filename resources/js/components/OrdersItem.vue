<template>
    <a href="/" class="order-item d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-start flex-column justify-content-center">
            <div class="destination deposit">вывод</div>
        ...
        .order-item  {
            ...
            * {
            ...
            .destination {
                ...
                &.withdraw {
                    background: linear-gradient(89.25deg, #FF9134 -64.01%, #E72269 99.5%);
                }
            }
            .datetime, .order-id {
                font-weight: 600;
