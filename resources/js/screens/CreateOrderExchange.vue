        ...
        >
            ...
            <div class="form-control">
                ...
                <div class="select-wrapper">
                    ...
                    >
                        <option
                            v-for="currency in fillterCurrencies"
                            :key="currency.id"
                            :data-crypto="currency.crypto"
            ...
            <div class="form-control">
                ...
                <div class="select-wrapper">
                    <select
                        ...
                        class="form-select select-payment"
            ...
            <div class="form-control amount-wrapper">
                ...
                <label for="amount" style="text-align: center;"
                    >*по лучшему курсу, за вычетом комиссии</label
                >
            </div>
            <div class="form-control">
                <label for="payment-network">Платёжная система</label>
...
export default {
    ...
    data() {
        return {
            fillterCurrencies: this.currencies.filter(
                item => item.visible == 1
            ),
    ...
    methods: {
        createOrder() {
            ...
            axios
                .post("/api/createOrderByUser", data)
                .then(response => {
        ...
        checkCurrency() {
            this.payments = this.fillterCurrencies.filter(
                item => item.title == this.currency
            )[0].payments;
