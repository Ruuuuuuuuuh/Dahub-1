                        ...
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-deposit-tab" data-toggle="pill"
                                   href="#pills-deposit" role="tab" aria-controls="pills-deposit" aria-selected="true">Получение</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-withdraw-tab" data-toggle="pill" href="#pills-withdraw"
                                   role="tab" aria-controls="pills-withdraw" aria-selected="false">Отправка</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-balances-tab" data-toggle="pill" href="#pills-balances"
                                   role="tab" aria-controls="pills-balances" aria-selected="false">Балансы системы</a>
                            </li>
