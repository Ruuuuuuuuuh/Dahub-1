                    ...
                    <div class="card-body" data-crypto="{{$currency->crypto}}">
                        ...
                        <form action="{{url()->current()}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input name="visible" type="checkbox" class="form-control"
                                       style="width: 20px;display: inline-block;vertical-align: middle;margin-left: 15px;"
                                       @if($currency->visible) checked @endif>
                            </div>
                            <div class="form-group">
