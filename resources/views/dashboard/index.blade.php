                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-start">
                            <ul class="nav nav-pills" id="balance-tabs" role="tablist">
                                    ...
                                    <a class="nav-link btn btn-outline-secondary" id="deposit-tab"
                                       ...
                                       aria-controls="deposit-area" aria-selected="false" @endif>
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M9.00011 9.96508C4.99278 9.96508 1.6489 8.50562 0.856695 6.56348C0.738086 6.84953 0.675293 7.14574 0.675293 7.44892C0.675293 9.81793 4.40164 11.7391 9.00011 11.7391C13.5967 11.7391 17.3243 9.81856 17.3243 7.44892C17.3243 7.1451 17.2583 6.84953 17.1435 6.56348C16.3488 8.50562 13.0049 9.96508 9.00011 9.96508Z"
                                                fill="white"/>
                                            <path
                                                d="M9.00011 13.0465C4.99278 13.0465 1.6489 11.5864 0.856695 9.64551C0.738086 9.93156 0.675293 10.2278 0.675293 10.5322C0.675293 12.9 4.40164 14.8212 9.00011 14.8212C13.5967 14.8212 17.3243 12.9006 17.3243 10.5322C17.3243 10.2278 17.2583 9.93156 17.1435 9.64551C16.3488 11.587 13.0049 13.0465 9.00011 13.0465Z"
                                                fill="white"/>
                                            <path
                                                d="M9.00011 16.2258C4.99278 16.2258 1.6489 14.7676 0.856695 12.8242C0.738086 13.1103 0.675293 13.4071 0.675293 13.7109C0.675293 16.0799 4.40164 17.9999 9.00011 17.9999C13.5967 17.9999 17.3243 16.0806 17.3243 13.7109C17.3243 13.4071 17.2583 13.1103 17.1435 12.8242C16.3488 14.7676 13.0049 16.2258 9.00011 16.2258Z"
                                                fill="white"/>
                                            <path
                                                d="M9.00045 8.57789C13.5978 8.57789 17.3246 6.65767 17.3246 4.28895C17.3246 1.92023 13.5978 0 9.00045 0C4.40313 0 0.67627 1.92023 0.67627 4.28895C0.67627 6.65767 4.40313 8.57789 9.00045 8.57789Z"
                                                fill="white"/>
                                        </svg>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link btn btn-outline-secondary" id="ref-tab" data-toggle="tab"
                                       href="#ref-area" role="tab" aria-controls="ref-area" aria-selected="false">
                                        <svg width="22" height="19" viewBox="0 0 22 19" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M8.24141 10.5688C10.7759 10.5688 12.8305 8.20286 12.8305 5.28438C12.8305 2.3659 10.7759 0 8.24141 0C5.70694 0 3.65234 2.3659 3.65234 5.28438C3.65234 8.20286 5.70694 10.5688 8.24141 10.5688Z"
                                                fill="#DDFFE9"/>
                                            <path
                                                d="M16.4785 17.9607C16.4785 15.175 15.443 12.6565 13.7629 10.9198C13.3762 10.519 12.7918 10.5042 12.4008 10.895C10.0031 13.2502 6.48398 13.2552 4.08633 10.895C3.69102 10.5091 3.10664 10.519 2.72422 10.9198C1.05273 12.6565 0 15.1651 0 17.9557C0 18.5297 0.403906 18.9997 0.902344 18.9997H15.5762C16.0746 18.9997 16.4785 18.5346 16.4785 17.9607Z"
                                                fill="#DDFFE9"/>
                                            <path
                                                d="M20.2813 12.5033C19.7828 12.9734 19.1942 13.3197 18.5496 13.5127C18.0598 13.6562 17.7676 14.2401 17.9051 14.8041C18.3348 16.5458 18.2875 18.0104 18.2875 17.9609C18.2875 18.5348 18.6914 19 19.1899 19H21.0891C21.5875 19 21.9914 18.5348 21.9914 17.9609C21.9914 14.72 22.0774 14.0916 21.695 12.9239C21.4758 12.2609 20.7582 12.058 20.2813 12.5033Z"
                                                fill="#DDFFE9"/>
                                            <path
                                                d="M17.4193 11.6225C18.9405 11.6225 20.1736 10.2026 20.1736 8.45092C20.1736 6.69928 18.9405 5.2793 17.4193 5.2793C15.8982 5.2793 14.665 6.69928 14.665 8.45092C14.665 10.2026 15.8982 11.6225 17.4193 11.6225Z"
                                                fill="#DDFFE9"/>
                                        </svg>
    ...
    <script>
        ...
        function changeInputValues(e) {
            let balance = {{ Auth::User()->getBalance('DHB') }}
                let
            amount = $('input[name="deposit-amount"]')
