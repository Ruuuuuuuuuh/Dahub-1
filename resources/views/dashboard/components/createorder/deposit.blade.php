<form class="form-deposit form-create-order" action="index.html" method="post">
    <input type="hidden" name="destination" value="deposit"/>
    ...
    <div class="form-control">
        ...
        <div class="select-wrapper">
            <select name="payment-network" class="form-select select-payment">
                @foreach ($currency::where('visible', 1)->first()->payments()->get() as $payment)
...
<a class="button button-blue create-order">Создать заявку</a>
