<div class="section-header">
    <div class="top-nav">
        ...
        <h2>Отправить {{number_format($order->amount, Auth::user()->getWallet($order->currency)->decimal_places, ',', ' ')}} {{$order->currency}}</h2>
...
<div class="section-main">
    ...
    <div class="text-block">
        ...
        <p style="color:#347AF0">Переведите {{number_format($order->amount, Auth::user()->getWallet($order->currency)->decimal_places, ',', ' ')}} {{$order->currency}}</p>
    </div>
