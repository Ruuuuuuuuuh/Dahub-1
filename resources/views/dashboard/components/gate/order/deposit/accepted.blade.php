...
<div class="section-main">
    ...
    <div class="text-block">
        <p>Как только пользователь подтвердит отправку средств, вам поступит уведомление в телеграме с последними 4 цифрами номера/счета, с которого были отправлены средства.</p>
    </div>
</div>
