        ...
        <div class="top-nav">
            ...
            <div class="section-header__icon">
                <svg width="44" height="45" viewBox="0 0 44 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M31 13H13C11.3 13 10 14.3 10 16V28C10 29.7 11.3 31 13 31H31C32.7 31 34 29.7 34 28V16C34 14.3 32.7 13 31 13ZM13 15H31C31.6 15 32 15.4 32 16V19H12V16C12 15.4 12.4 15 13 15ZM13 29H31C31.6 29 32 28.6 32 28V21H12V28C12 28.6 12.4 29 13 29Z" fill="black"/>
