    ...
    <div class="section-main">
        ...
        <div class="payment-items">
            @foreach (Auth::user()->paymentDetails()->get() as $payment)
                ...
                <a class="payment-item " data-address="{{$payment->address}}" data-id="{{ $payment->id }}" data-payment="{{$payment->payment()->first()->title}}">
                    <div class="payment-item_content d-flex align-items-center justify-content-between">
