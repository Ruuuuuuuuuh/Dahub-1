...
<p style="margin-bottom:35px;">Цена 1 DHB = {{Rate::$DHBRate}} USD</p>
...
<p>{{ number_format(Auth::User()->getWallet('DHB')->balance, 2, ',',' ') }} DHB = {{ number_format((Auth::User()->getWallet('DHB')->balance * Rate::$DHBRate), 2, ',' , ' ')}} USD</p>
