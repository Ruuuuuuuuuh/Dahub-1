        ...
        <div class="progress-labels w-100 d-flex justify-content-end align-items-center" style="padding-left:calc(50% - {{($balances['frozen'] / 2000000) * 100 }}%)">
