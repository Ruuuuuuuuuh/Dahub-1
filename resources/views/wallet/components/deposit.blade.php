    ...
    <div class="new-order">
        ...
        <div class="deposit-block form-inline">
            <div class="form-group input-group">
                <input type="number" class="form-number form-control" name="deposit-amount" value="2000" min="2000" step="1000" max="200000"  />
            ...
            <div class="form-group deposit-recieve-group">
                <p>
                    ...
                    <span class="deposit-recieve">{!! 2000 * Rate::$DHBRate !!}</span>
                </p>
            </div>
        ...
        <div class="subtotal">
            ...
            <p class="subtotal-amount"><span>{{ number_format(Auth::User()->getWallet('DHB')->balance + 2000, 2, ',',' ')  }}</span> DHB</p>
        </div>
