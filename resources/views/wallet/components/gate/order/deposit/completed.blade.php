...
<div class="section-main">
    ...
    <div class="text-block">
        ...
        <p style="color:#347AF0">Заявка выполнена.
            <br />Получение подтверждено.
            <br />Вам начислено {{round($order->amount * Rate::getRates($order->currency) / 200 / Rate::getRates('DHB'))}} DHB.</p>
    </div>
    <div class="footer">
