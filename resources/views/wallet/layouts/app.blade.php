...
<div class="app" id="app-vue" data-mode="{{$mode}}" data-page="{{Route::current()->getName()}}">
    @include('wallet.components.header')
    @include('wallet.components.menu')
    @yield('content')

    @include('wallet.components.createorder')
    @include('wallet.components.gate.payments-screen')
</div>
...
<noscript>
    <div><img src="https://mc.yandex.ru/watch/86626209" style="position:absolute; left:-9999px;" alt=""/></div>
</noscript>
<!-- /Yandex.Metrika counter -->
@yield('scripts')
</body>
