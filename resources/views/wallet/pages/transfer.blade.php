                    ...
                    <div class="card-body">
                        ...
                        <form action="" id="form-transfer">
                            ...
                            <div class="form-group input-group col-12 col-md-6 p-0 mb-5">
                                ...
                                <input type="text" class="form-text form-control w-100" name="username" placeholder="Введите id пользователя либо идентификатор фонда">
                            ...
                            <label for="transfer-amount">Сколько DHB перевести. Доступно для перевода: {{intval(Auth::user()->getWallet('DHB')->balanceFloat)}} DHB</label>
                            <div class="form-group input-group col-12 col-md-6 p-0 mb-5 w-100">
                                <div class="w-100 d-flex">
                                    <div class="col-7">
                                        <div class="row">
                                            <input type="number" class="form-number form-control w-100" name="transfer-amount" placeholder="Сколько перевести">
                                            <div class="invalid-feedback">Введите количество DHB</div>
                                        </div>
                                    </div>
                                    <div class="col-5 pr-0">
                                        <a class="text-center d-flex w-100 align-items-center justify-content-center bg-danger text-light add-all" data-amount="{{intval(Auth::user()->getWallet('DHB')->balanceFloat)}}">Добавить все</a>
                                    </div>
                                </div>
