...
(function ($) {
  ...
  app.initWebGL = function () {
    ...
    renderer.setClearColor(0xd3edfc, 1); // the default
  ...
  var initApp = function initApp() {
    ...
    secTransTimeline = new TimelineMax({
      onComplete: function onComplete() {
        ...
        switch (app.currentSection) {
          case 'welcome':
		  	TweenMax.to($('.site-menu'), 1, { y: '0px', autoAlpha: 1, ease: Power2.easeOut }).delay(2.6);
            break;
          case 'projects':
            // Show header & footer
            TweenMax.to($('.site-menu'), 1, { y: '0px', autoAlpha: 1, ease: Power2.easeOut });
            break;
          case 'about':
            break;
        }
    ...
    * -------------------------------------------------- */
    ...
    welcome = {
      ...
      textSlideshowTimeline: new TimelineMax({ repeat: -1, repeatDelay: 1, paused: true })
    };
    ...
    // Show tiny copy
    .add(lineTimeline.play(), 0).add(buttonTimeline.play(), 0).add(welcome.textSlideshowTimeline.play(), 0);
    ...
    * ====================================================================== */
    ...
    app.goToSection = function (section) {
      ...
      // console.log( 'Switching sections: %c' + app.currentSection + '%c â†’ %c' + section, 'color:yellow', 'color:default', 'color:green' );
    ...
    * -------------------------------------------------- */
    ...
    introTimeline.add(welcome.enterTimeline.play(), 2.6).play();
  };
...
jQuery('.home-title h1').css({'opacity' : 1, 'marginTop' : 0});
jQuery('.copy-line').css({'opacity' : 1});
